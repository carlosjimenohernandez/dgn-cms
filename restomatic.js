...
const RestomaticAPI = {
  create: async function(options = {}) {
    ...
    Restomatic.utils.buildSqlCreateTable = function(modelId, modelMetadata) {
      if (typeof modelMetadata === "string") {
        return Restomatic.utils.buildSqlCreateTableBySource(modelId, modelMetadata);
      }
    ...
    // @file[8] = src/utils/buildSqlCreateTableBySource.js
    ...
    // @file[9] = src/utils/buildSqlRemoveColumn.js
    ...
    // @file[10] = src/utils/buildSqlRemoveTable.js
    ...
    // @file[11] = src/utils/buildSqlWhere.js
    ...
    // @file[12] = src/utils/buildSqlSelect.js
    ...
    // @file[13] = src/utils/buildSqlInsert.js
    ...
    // @file[14] = src/utils/buildSqlUpdate.js
    ...
    // @file[15] = src/utils/buildSqlDelete.js
    ...
    // @file[16] = src/utils/getSchema.js
  ...
  `);
    ...
    // @file[17] = src/utils/getRandomString.js
    ...
    // @file[18] = src/utils/formatDate.js
    ...
    // @file[20] = src/utils/executeSql.js
    ...
    // @file[21] = src/controllers/api/v1/data/schema.js
    ...
    // @file[22] = src/controllers/api/v1/data/select.js
    ...
    // @file[23] = src/controllers/api/v1/data/insert.js
    ...
    // @file[24] = src/controllers/api/v1/data/update.js
    ...
    // @file[25] = src/controllers/api/v1/data/delete.js
    ...
    // @file[26] = src/controllers/api/v1/data/createTable.js
    ...
    // @file[27] = src/controllers/api/v1/data/createColumn.js
    ...
    // @file[28] = src/controllers/api/v1/data/removeTable.js
    ...
    // @file[29] = src/controllers/api/v1/data/removeColumn.js
    ...
    // @file[30] = src/controllers/api/v1/data/listFiles.js
    ...
    // @file[31] = src/controllers/api/v1/data/setFile.js
    ...
    // @file[32] = src/controllers/api/v1/filesystem/readDirectory.js
    ...
    // @file[33] = src/controllers/api/v1/filesystem/makeDirectory.js
    ...
    // @file[34] = src/controllers/api/v1/filesystem/deleteDirectory.js
    ...
    // @file[35] = src/controllers/api/v1/filesystem/readFile.js
    ...
    // @file[36] = src/controllers/api/v1/filesystem/writeFile.js
    ...
    // @file[37] = src/controllers/api/v1/filesystem/deleteFile.js
    ...
    // @file[38] = src/controllers/api/v1/filesystem/isFile.js
